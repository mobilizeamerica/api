...
| timeslot_id | integer | Foreign Key to the Timeslot this VAN signup belongs to, if the signup is for an event owner |
...
| participation_id | integer | Foreign Key to the Participation this VAN signup belongs to, if the signup is for a participation |
